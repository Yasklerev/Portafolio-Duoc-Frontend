...
export class DetalleServicioComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.cargaService.obtenerSolicitud(this.data).subscribe((data: any) => {
  ...
  responseVendor() {
    const data = {
      numero: this.data.solicitud_id,
    };

    this.cargaService.obtenerSolicitud(data).subscribe((data: any) => {
      if (data.error === false) {
        Swal.fire({
          position: 'top-end',
          icon: 'success',
